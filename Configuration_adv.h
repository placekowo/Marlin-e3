...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { { 70, 46 }, { 195, 46 }, { 195, 213 }, { 71, 213 } }
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  44          // (Hz) The default dominant resonant frequency on the X axis.
...
#define LIN_ADVANCE
  ...
  #else
    #define ADVANCE_K 0.88        // (mm) Compression length applying to all extruders
  #endif
